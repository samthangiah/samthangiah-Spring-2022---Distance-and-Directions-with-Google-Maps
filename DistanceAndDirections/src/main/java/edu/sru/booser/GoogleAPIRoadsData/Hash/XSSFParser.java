...
public  class XSSFParser {
	...
	public static void booserParser(String fileName, DataController dc, Table dt) throws IOException, InterruptedException {
		String oriIn;
		String desIn;
		...
		Iterator<Row> itrRow = sheet.iterator();
			while(itrRow.hasNext())
			{
				...
				oriIn = itrCell.next().toString();
				desIn = itrCell.next().toString();
				API_DistanceMatrix.getDistance(oriIn, desIn, dc, dt);
