...
public class Table implements java.io.Serializable{
	...
	private static Table JarTable = null;
	private static DataController dc;
	private static Hashtable<Integer, DataObject> table = new Hashtable<Integer, DataObject>();
	
	/*
	public static Table JarTable()
	{
		if(JarTable == null)
		{
	...
	public static void add(String origin, String destination, float getqDistance) {
		String temp = origin.concat(destination);
		float distance = 0;
		table.put(temp.hashCode(), new DataObject(origin, destination, distance));
	}
	 ...
	 */
	public static DataObject getDataObject(String origin, String destination) {
		String temp = origin.concat(destination);
		return  table.get(temp.hashCode());
	}
	
	public static Boolean contains(String origin, String destination) {
